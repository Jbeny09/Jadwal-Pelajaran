  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg font-semibold bg-gradient-to-r from-purple-500 via-red-500 to-pink-500 bg-clip-text text-transparent bg-[length:200%_200%] animate-rainbow">
          Kelas XI-4
        </p>
      </div>
