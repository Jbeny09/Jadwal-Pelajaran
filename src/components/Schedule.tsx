...
const scheduleData: DaySchedule[] = [
  {
    ...
    subjects: [
      ...
      { name: "Mata Pelajaran Pilihan", teacher: "", room: "", time: "07.35 - 08.15" },
      { name: "Mata Pelajaran Pilihan", teacher: "", room: "", time: "08.15 - 08.55" },
      { name: "Mata Pelajaran pilihan", teacher: "", room: "", time: "08.55 - 09.35" },
      { name: "Istirahat", teacher: "", room: "", time: "09.35 - 10.05" },
      { name: "Mata Pelajaran pilihan", teacher: "", room: "", time: "10.05 - 10.45" },
      { name: "Mata Pelajaran pilihan", teacher: "", room: "", time: "10.45 - 11.25" },
      { name: "Mata Pelajaran pilihan", teacher: "", room: "", time: "11.25 - 12.05" },
      { name: "Mata Pelajaran pilihan", teacher: "", room: "", time: "12.05 - 12.45" },
